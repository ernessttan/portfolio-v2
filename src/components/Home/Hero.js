function Hero() {
  return (
    <section className="py-8 md:py-14 md:flex md:gap-24 lg:py-28">
      <img className="rounded-full h-52 w-52 md:order-2 md:h-80 md:w-80" src="/images/ernest.jpeg" alt="ernest hero" />
      <div className="my-5 md:order-1">
        <h1 className="dark:dark-text md:desktop">Hey there! Im Ernest</h1>
        <p className="py-3 dark:dark-text md:desktop">
