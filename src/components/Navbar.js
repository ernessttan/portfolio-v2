  ...
  return (
    <nav className="p-5">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <a href="ernesttan.com">
          <img className="mr-3 h-6 sm:h-9" src={logo} alt="Personal Logo" />
        </a>
        <button onClick={handleNavExpansion} type="button" className="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
