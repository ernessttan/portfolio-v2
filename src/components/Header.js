...
function Header({ darkMode, toggleDarkMode }) {
  ...
  return (
    <header
      className="flex flex-wrap items-center justify-between w-full px-5 py-3 dark:bg-black md:flex-nowrap md:px-14"
    >
      <NavLink to="/">
        <svg
          className="h-8 w-8 fill-black lg:w-12 lg:h-12 dark:fill-offwhite"
          viewBox="0 0 77 44"
      ...
      <button
        className="w-7 h-7 dark:text-offwhite md:hidden"
        type="button"
        onClick={toggleNav}
      >
        <MenuIcon />
