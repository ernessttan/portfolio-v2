...
function Footer() {
  return (
    <footer className="bg-offwhite -mx-8 -my-8 p-5 px-8 dark:bg-lightblack dark:dark-text md:-mx-14 md:p-10 md:px-14">
      <svg className="w-8 h-8 fill-black dark:fill-offwhite" viewBox="0 0 77 44" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="my-3 flex gap-5 md:gap-15 md:flex-row">
        <NavLink className="nav-link md:desktop" to="/">Home</NavLink>
        <NavLink className="nav-link md:desktop" to="/">Projects</NavLink>
        <NavLink className="nav-link md:desktop" to="/contact">Contact</NavLink>
      </div>
      ...
      <div className="flex items-center gap-2 my-3">
        ...
        <p className="dark:dark-text">Copyright 2022, Ernest Tan</p>
      </div>
    </footer>
  );
}
